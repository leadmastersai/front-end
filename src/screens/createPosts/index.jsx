      ...
      <div className="c88" style={{ marginInline: "auto" }}>
        <div className="profile-cont">
          <img
            ...
            className={profilepic ? "avtar-usr" : "avtar"}
          />
        ...
        <div className="bottom-cont">
          ...
          <img
            src={post}
            className="btm-img"
            style={{ marginLeft: "13%", marginRight: "1%" }}
            onClick={() => {
          ...
          <img
            ...
            src={schedule}
            className="btm-img"
            style={{ marginLeft: "6%", marginRight: "1%" }}
          />
          <p className="para1" onClick={() => handleCardClick(data)}>
            Schedule Now
          </p>
          <img
            src={write}
        ...
        >
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            ...
            <div style={{ marginTop: "1em", textAlign: "center" }}>
              ...
              >
                {loading2 ? <Spin size="small" /> : "Schedule"}
              </button>
            </div>
        ...
        <button><img src={expand} className='write-img'/>Add Hashtags</button>
          ...
          <div className="message-input">
            <input
              ...
              style={{ widows: "80%" }}
            />
            <button className="send-button" onClick={getAiData}>
              <img src={send} className="write-img1" />
            </button>
          </div>
  ...
  <span>Pickup Slot</span>
      ...
      {loading4 && (
        <div ref={skeletonRef}>
          ...
          <Skeleton
            active
            style={{ width: "60%", marginLeft: "10%", marginInline: "auto" }}
          />
        </div>
      )}
    </>
