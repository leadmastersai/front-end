  ...
  return (
    <div>
      <div className="container-section99">
        <h1 className="biggest-text91 closs closs1">Terms and Conditions
        </h1>
      ...
      <div className="privacy-policy-container">
            ...
            <p><strong>1.4 “Services”</strong> means the lead generation, ad optimization, and social media integration services provided by LeadMasters AI.</p>
            ...
            <ul>
                ...
                <li>Use automated systems, such as bots or scripts, to interact with our Services.</li>
            </ul>
            ...
            <p>
                All payments are final unless otherwise specified. Refunds may be granted at our sole discretion under specific 
                circumstances outlined in our Refund Policy. If you believe you are entitled to a refund, please contact us at 
                support@leadmasters.ai within 30 days from the date of payment.
            </p>

            <h2>7. License</h2>
            <p>
                LeadMasters AI grants you a limited, non-exclusive, non-transferable license to access and use the platform for 
                your personal or business purposes.
            </p>

            <h2>8. Intellectual Property</h2>
            <p>
                All content and materials on the platform, including but not limited to software, logos, graphics, and text, are 
                owned by LeadMasters AI or its licensors. You are not permitted to reproduce, distribute, or modify any content 
                without prior written permission from LeadMasters AI.
            </p>

            <h2>9. Termination</h2>
            <p>
                LeadMasters AI reserves the right to suspend or terminate your access to the platform without cause or notice if 
                you violate these Terms or engage in any unlawful activity, or for any other reason at our sole discretion.
            </p>

            <h2>10. Dispute Resolution</h2>
            <p>
                Any disputes arising under these Terms shall be resolved by binding arbitration in accordance with the Arbitration 
                and Conciliation Act, 1996, of India. The location of arbitration shall be Bangalore, India, and the language of 
                arbitration shall be English.
            </p>

            <h2>11. Limitation of Liability</h2>
            <p>
                LeadMasters AI shall not be liable for any indirect, incidental, special, or consequential damages arising out of 
                your use of the platform, including but not limited to loss of data or profit. In no event shall our liability 
                exceed the amount paid by you for the service in the preceding 12 months.
            </p>

            <h2>12. Indemnity</h2>
            <p>
                You agree to indemnify, defend, and hold harmless LeadMasters AI and its affiliates, officers, employees, and 
                agents from any claims, liabilities, damages, losses, or expenses, including legal fees, arising out of your use 
                of the platform or breach of these Terms.
            </p>

            <h2>13. Service Availability</h2>
            <p>
                While we strive to ensure continuous access to our platform, we cannot guarantee uninterrupted service. LeadMasters 
                AI shall not be liable for any outages or disruptions caused by scheduled maintenance, third-party service outages, 
                or events beyond our control.
            </p>

            <h2>14. Third-Party Services</h2>
            <p>
                LeadMasters AI integrates with third-party services such as Google Ads, Facebook, LinkedIn, and others. Your use of 
                such third-party services is subject to their respective terms and conditions. LeadMasters AI is not responsible for 
                any actions, policies, or data practices of these third-party services.
            </p>
            ...
            <p>
                LeadMasters AI reserves the right to terminate any account without cause and without prior notice. If your account 
                is terminated, you may no longer access our platform or services.
            </p>

            <h2>17. No Waiver</h2>
            <p>
                Failure by LeadMasters AI to enforce any part of these Terms at any time does not constitute a waiver of our right 
                to enforce it in the future.
            </p>

            <h2>18. User-Generated Content</h2>
            <p>
                Any content created or uploaded by users (including ad copy, social media posts, etc.) remains the property of the 
                user. However, by uploading such content, you grant LeadMasters AI a worldwide, royalty-free, non-exclusive, 
                perpetual license to use, display, distribute, and modify such content in connection with the operation of the platform.
            </p>

            <h2>19. Modifications to Terms</h2>
            <p>
                LeadMasters AI reserves the right to modify these Terms at any time. Any changes will be effective immediately upon 
                posting to the platform. Your continued use of the platform after the posting of the modified Terms constitutes your 
